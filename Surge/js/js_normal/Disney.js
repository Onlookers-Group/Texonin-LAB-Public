...
const DEFAULT_OPTIONS = {
  title: 'Ready to check Disney.',
  availableContent: 'You can watch Disney in #REGION_CODE#.',
  availableIcon: 'checkmark.seal',
  availableIconColor: '#16A951',
  availableStyle: 'good',
  comingtitle: 'Ready to check Disney.',
  comingContent: 'Soon you will watch Disney in #REGION_CODE#.',
  comingIcon: 'exclamationmark.triangle',
  comingIconColor: '#FFD700',
  comingStyle: 'info',
  notAvailabletitle: 'Ready to check Disney.',
  notAvailableContent: "You can't watch Disney!",
  notAvailableIcon: 'eye.slash',
  notAvailableIconColor: '#DC143C',
  notAvailableStyle: 'alert',
  errortitle: 'Ready to check Disney.',
